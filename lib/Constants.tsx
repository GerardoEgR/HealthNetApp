...
export const services = [
  ...
  {
    id: 5,
    icon: <svg xmlns='http://www.w3.org/2000/svg' fill='#ffffff' width='24' height='24' viewBox='0 0 24 24'><path d='M15 2.013H9V9H2v6h7v6.987h6V15h7V9h-7z'></path></svg>,
  ...
  {
    id: 8,
    icon: <svg xmlns='http://www.w3.org/2000/svg' fill='#ffffff' width='24' height='24' viewBox='0 0 24 24'><path d='M20 6h-3V4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2zM9 4h6v2H9zm7 10h-3v3h-2v-3H8v-2h3V9h2v3h3z'></path></svg>,
    title: 'Telemedicina',
...
export const steps = [
  {
    ...
    checkIcon: <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth='1.5' stroke='currentColor' className='size-6'>
      <path stroke-linecap='round' stroke-linejoin='round' d='m4.5 12.75 6 6 9-13.5' />
    </svg>,
    title: 'BÚSQUEDA',
    path: '/agenda',
    pathBack: '/',
    pathNext: '/agenda/select'
  },
  {
    id: 2,
    icon: <svg xmlns='http:www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth='1.5' stroke='currentColor' className='w-6 h-6'>
    ...
    path: '/agenda/select',
    pathBack: '/agenda',
    pathNext: '/agenda/identification'
  },
  {
    id: 3,
    ...
    pathBack: '/agenda/select',
    pathNext: '/agenda/success'
  },
  {
    id: 4,
    icon: <svg fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' className='w-6 h-6' viewBox='0 0 24 24'>
    ...
    path: '/agenda/success',
    pathBack: '/agenda/identification',
    pathNext: '/'
  }
]
